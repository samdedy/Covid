...
public class Data implements Serializable, Parcelable
{
    ...
    ;
    private final static long serialVersionUID = -2874586796030848636L;
     ...
     * @param status
     */
    public Data(Integer id, String username, String kondisi, String lat, String lon, String timestamp, String status, String namaLengkap, String umur, String jenisKelamin, String kotaDomisili, String noTelepon, String picture) {
        super();
        this.id = id;
